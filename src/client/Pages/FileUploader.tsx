...
const FileUploader = () => {
  ...
  const UploadFile: () => Promise<void> = async () => {
    ...
    try {
      const response = await Axios.post("https://localhost:5174/uploads", formData);
 ...
 return (
  <div className="min-h-screen px-4 flex flex-col items-center justify-center mt-16 sm:mt-20 md:mt-24">
    <div
      className="flex flex-col items-center justify-center p-4 sm:p-6 md:p-8 max-w-full sm:max-w-md md:max-w-lg lg:max-w-2xl text-center font-nunito"
    >
    ...
    >
      ...
      <div className="flex flex-col justify-center items-center">
        <h1 className="text-slate-400 text-center mb-3 text-sm sm:text-base mb-1">
          Drag & Drop files or choose them from your device.
        </h1>
        <p className="text-slate-400 text-xs sm:text-sm">Maximum size: 100MB</p>
      </div>
    </div>
    <button
